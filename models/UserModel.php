...
class UserModel{
    ...
    public static function validateUser($conn, $email, $password){
       ...
       $sql = "SELECT usuarios.id, usuarios.nome, usuarios.senha, usuarios.email, roles.nome AS roles FROM usuarios 
       JOIN roles ON roles.id = usuarios.role_id WHERE usuarios.email = ?;";
